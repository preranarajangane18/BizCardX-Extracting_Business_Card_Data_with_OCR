...
icon = Image.open(r"C:\Users\HP\Desktop\Bizcard\icon.webp")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By PRERANA",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by PRERANA!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open(r"C:\Users\HP\Desktop\Bizcard\home.jpg"), width=500)
